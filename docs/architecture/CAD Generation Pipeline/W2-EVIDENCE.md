...
## 16. Dense-frame path (a) — the 100-keyframe splat (2026-08-24)
...
### 16.1 Bringing the dense frames to staging
...
### 16.3 Metrics caveat — held-out LPIPS/PSNR are N/A for this run
...
### 16.4 THE VISUAL VERDICT — recognizably a room, not a clump
