...
- **SMOKE-04 remainder + SMOKE-05** — ~267 real app/api-client type errors (pre-existing app debt, a separate file-by-file cleanup) + migrate deprecated `next lint` → ESLint CLI. Needed before `tsc`/lint can gate CI.
