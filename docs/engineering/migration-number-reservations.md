...
visit/suggestion migration); `00533–00535` remain reserved symbolically so the
two neighbouring lanes can plan around them. Every address is claimed at the
