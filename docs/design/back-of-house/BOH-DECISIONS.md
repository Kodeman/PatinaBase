...
*Entries: D1 · O1 (resolved) · O2 (open) · O3 (near-resolved) · I1–I11 · R1–R3 · L— · last id = I11 · footer maintained manually (append_entry.py targets the-document's DECISIONS.md only — see I1 discussion; this file's footer follows the same cumulative-index convention by hand)*
