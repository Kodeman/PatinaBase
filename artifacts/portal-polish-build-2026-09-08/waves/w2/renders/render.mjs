...
const OUT = '/Users/kody/Code/patina-merged/artifacts/portal-polish-build-2026-09-08/waves/w2/renders';
...
const viewports = [
  { name: 'house-1440x900', width: 1440, height: 900, scale: 1 },
  { name: 'house-390x844@2x', width: 390, height: 844, scale: 2 },
];
