...
await ask.screenshot({ path: `${SH}/05c-early-release-cancelled.png` });
...
await page.screenshot({ path: `${SH}/05d-pointer-midhold.png`, clip: { x: box.x - 8, y: box.y - 8, width: box.width + 16, height: box.height + 16 } });
