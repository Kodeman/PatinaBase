...
await draft.screenshot({ path: '/Users/kody/Code/patina-merged/artifacts/client-approval-experience-2026-09-03/build/waves/w2/web-walk-shots-r2/02-draft-conditional-sentence.png' });
const aw = askBy(page, 'Awaiting studio');
await aw.scrollIntoViewIfNeeded(); await page.waitForTimeout(300);
await aw.screenshot({ path: '/Users/kody/Code/patina-merged/artifacts/client-approval-experience-2026-09-03/build/waves/w2/web-walk-shots-r2/02b-awaiting-studio-silent.png' });
...
await ask.screenshot({ path: '/Users/kody/Code/patina-merged/artifacts/client-approval-experience-2026-09-03/build/waves/w2/web-walk-shots-r2/03-return-chosen.png' });
...
await ask.screenshot({ path: '/Users/kody/Code/patina-merged/artifacts/client-approval-experience-2026-09-03/build/waves/w2/web-walk-shots-r2/03b-return-note-filled.png' });
...
await ask.screenshot({ path: '/Users/kody/Code/patina-merged/artifacts/client-approval-experience-2026-09-03/build/waves/w2/web-walk-shots-r2/03c-return-submitted.png' });
