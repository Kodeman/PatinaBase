...
## From L1-F — round 3 (fix round, 2026-09-02)

Written after the round-1 adversarial review (`RL1F-01`…`RL1F-18`) and after applying
`build/waves/w1/l1-f-notes.md`. Full text, with what L1-F applied from your notes, is at
`build/waves/w1/l1f-notes-out-round3.md`.
