...
await shot(page, 'wh-step8-preview-1280');
...
await shot(page, 'wh-step8-preview-390');
...
await page.waitForTimeout(2500);
await shot(page, 'wh-step9-send-sheet-1280');
...
await shot(page, 'wh-step9-after-send-1280');
await b.close();
