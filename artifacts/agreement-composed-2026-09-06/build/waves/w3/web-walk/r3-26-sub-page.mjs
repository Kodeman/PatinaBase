import { launch, shot, shot390, textOf, CLIENT } from './lib3.mjs';
...
console.log(t);
await shot(page, 'r3-26a-trade-token');
await shot390(page, 'r3-26b-trade-token-390');
...
await shot(page, 'r3-26c-trade-form-filled');
...
await shot(page, 'r3-26d-trade-signed');
console.log('\n=== AFTER SIGNING ===');
...
await shot(p2, 'r3-26e-trade-second-load');
