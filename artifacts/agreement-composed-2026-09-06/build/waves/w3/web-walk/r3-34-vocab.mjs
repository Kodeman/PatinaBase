import { launch, dismissOverlays, DESIGNER, CLIENT, HERE } from './lib3.mjs';
...

{
  ...
  await exec.goto(`${DESIGNER}/drafting/8cac8743-9b06-40ba-aeab-aa6a1829070b`, {
    waitUntil: 'domcontentloaded',
  });
...
fs.writeFileSync(`${HERE}/r3-rendered-text.json`, JSON.stringify(out, null, 1));
