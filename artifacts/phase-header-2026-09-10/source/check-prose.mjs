// Word-budget gate. Run: node source/check-prose.mjs [deck.html]  (default ../the-standing-head.html)
//
...
const proposalPath = process.argv[2] ? path.resolve(process.argv[2]) : path.join(here, '..', 'the-standing-head.html');
