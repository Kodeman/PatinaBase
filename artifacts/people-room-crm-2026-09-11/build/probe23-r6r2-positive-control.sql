...
\echo '### LIVE FIXED body ###'
\echo '(using the LIVE, FIXED body — nothing installed)'

SELECT pg_temp.assume_user('a0000000-0000-4000-8000-0000000000f1');

\echo ''
\echo '=== R6-M1 (fixed): a written grant, then a verbal refusal ==='
...
\echo ''
\echo '=== R6-M2 (fixed): a grant with v2, then a refusal with disclosure = empty string ==='
...
\echo ''
\echo '=== R6-M3 (fixed): an email refusal, then a fully evidenced grant ==='
