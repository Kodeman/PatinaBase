...
describe('Divider', () => {
  ...
  it('applies medium thickness correctly', () => {
    const { container } = render(<Divider thickness="medium" />)
    const divider = container.querySelector('hr')
  ...
  it('applies spacing correctly for vertical', () => {
    const { container } = render(<Divider orientation="vertical" spacing="md" />)
    const divider = container.querySelector('hr')
  ...
  it('renders label on left when specified', () => {
    const { container } = render(<Divider label="Start" labelPosition="left" />)
  ...
  it('renders label on right when specified', () => {
    const { container } = render(<Divider label="End" labelPosition="right" />)
  ...
  it('ignores label for vertical dividers', () => {
    const { container } = render(
      <Divider orientation="vertical" label="Should not appear" />
    )
  ...
  it('combines multiple variants correctly', () => {
    const { container } = render(
      <Divider variant="dashed" thickness="medium" spacing="lg" />
    )
    const divider = container.querySelector('hr')
