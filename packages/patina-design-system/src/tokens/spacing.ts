...
/**
 * Common spacing presets for layouts
 */
export const layoutSpacing = {
  sectionVertical: spacing[16], // 64px
  sectionHorizontal: spacing[8], // 32px
...
export type ContainerMaxWidths = typeof containerMaxWidths
