...
//  (C3/C5/V3). FROZEN SCHEMA: this and its children are CaptureSchemaV1
//  (CaptureSchema.swift), what a store Field has shipped holds. A stored-property
//  change is a new VersionedSchema plus its stage in CaptureMigrationPlan, never
//  an edit here.
//
...
extension CaptureSchemaV1 {
    ...
    public final class Specimen {
        ...
        /// OPTIONAL so SwiftData migrated it lightweight, before this app had a
        /// VersionedSchema. `voiceAudioFilename` stays segment 0 for every reader
