...
app.build_configurations.each do |c|
  ...
  # CFBundleVersion. ASC rejects a re-used build number, so this MUST be past
  # the ASC high-water mark before every upload. 7 = the last recorded upload,
  # 0.1 (6), plus one. Kody must confirm 7 exceeds the ASC high-water mark
  # before any archive (he reports it is above 6).
