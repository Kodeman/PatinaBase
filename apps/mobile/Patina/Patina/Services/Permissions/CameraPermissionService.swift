...
/// Camera-permission disclosure copy. It mirrors the shipped held-local scan
/// pipeline: RoomPlan geometry and reference photos stay on this iPhone after
/// scanning, then upload only when the person explicitly sends the room
/// through design services.
