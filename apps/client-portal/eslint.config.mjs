...
// preset, pre-composed). Replaces the legacy `.eslintrc.json` (extends:
// ["next/core-web-vitals"]), whose two custom rule overrides are ported
// below unchanged. apps/designer-portal/eslint.config.mjs was written
