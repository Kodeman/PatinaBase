...
|---|---|---|
| `/three/draco/draco_decoder.js` | `three/examples/jsm/libs/draco/gltf/draco_decoder.js` | three 0.159.0 |
| `/three/draco/draco_decoder.wasm` | `three/examples/jsm/libs/draco/gltf/draco_decoder.wasm` | three 0.159.0 |
| `/three/draco/draco_wasm_wrapper.js` | `three/examples/jsm/libs/draco/gltf/draco_wasm_wrapper.js` | three 0.159.0 |
| `/three/basis/basis_transcoder.js` | `three/examples/jsm/libs/basis/basis_transcoder.js` | three 0.159.0 |
| `/three/basis/basis_transcoder.wasm` | `three/examples/jsm/libs/basis/basis_transcoder.wasm` | three 0.159.0 |
...
48a0ef319a28bf0224ee88ded34f74eaf97c175bba9eb18b47fb9720510ad6c4  basis/basis_transcoder.js
79ae97d781e10a566659c689b7bb1de91726453f55f9f5e3bcc07a4e3904070f  basis/basis_transcoder.wasm
```
