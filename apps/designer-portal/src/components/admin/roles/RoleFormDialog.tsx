...
import { useAdminPermissionsGrouped, useCreateAdminRole, useUpdateAdminRole, useReplaceAdminPermissions } from '@/hooks/admin/use-roles';
...
export function RoleFormDialog({ open, onOpenChange, role, onSuccess }: RoleFormDialogProps) {
  ...
  const replacePermissionsMutation = useReplaceAdminPermissions();
