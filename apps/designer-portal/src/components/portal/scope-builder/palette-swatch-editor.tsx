  ...
  return (
    <div className="flex items-center gap-3 rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] p-3">
      ...
      <input
        ...
        className="min-w-0 flex-1 rounded border border-[var(--border-default)] bg-transparent px-2 py-1 text-sm focus:border-[var(--accent-primary)] focus:outline-none"
      />
      ...
      <select
        ...
        className="rounded border border-[var(--border-default)] bg-transparent px-2 py-1 text-sm focus:border-[var(--accent-primary)] focus:outline-none"
      >
