...
interface ProductEditorModalProps {
  ...
  product?: Product;
  onSave: (product: Product, mode: 'create' | 'edit') => Promise<void>;
  activeTab?: string;
...
export function ProductEditorModal({
  ...
  const saveLabel = mode === 'create' ? 'Create product' : 'Save changes';
  const isSaveDisabled = !productData || saveState === 'saving';
