  ...
  return (
    <span className="relative inline-flex items-baseline gap-1">
      ...
      <button
        ...
        className="border-b border-transparent bg-transparent font-mono text-[10px] text-[var(--text-primary)] hover:border-[var(--color-pearl)] focus:border-[var(--color-clay)] focus:text-[var(--color-charcoal)] focus:outline-none disabled:opacity-50"
      >
        {value ? fmtDay(value) : '—'}
      </button>
      {value && (
        <button
          ...
          onClick={clear}
          disabled={state === 'saving'}
          className="font-mono text-[9px] text-[var(--text-muted)] hover:text-[var(--color-clay-ink)] disabled:opacity-50"
        >
          ×
        </button>
      )}
  ...
  return (
    <span className="inline-flex items-baseline">
      <input
        ...
        className="border-b border-transparent bg-transparent text-right font-mono text-[10px] text-[var(--text-primary)] placeholder:text-[var(--text-muted)] hover:border-[var(--color-pearl)] focus:border-[var(--color-clay)] focus:text-[var(--color-charcoal)] focus:outline-none disabled:opacity-50"
      />
      <SaveDot state={state} errorMsg={errorMsg} />
    </span>
  );
      ...
      <div className="flex flex-wrap items-baseline gap-x-3 gap-y-0.5 text-[11px] text-[var(--text-primary)]">
        ...
        {bandUnset && !bandOpen ? (
          <button
            ...
            className="font-mono text-[8px] uppercase tracking-[0.06em] text-[var(--text-muted)] hover:text-[var(--color-clay-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-clay)]"
          >
            Set a budget band
          </button>
        ) : (
          <span className="inline-flex items-baseline gap-0.5">
            ...
            <span className="font-mono text-[10px] text-[var(--text-primary)]">$</span>
            <VitalMoney
              projectId={projectId}
              column="budget_min"
        ...
        <button
          ...
          className="font-mono text-[8px] uppercase tracking-[0.06em] text-[var(--text-muted)] hover:text-[var(--color-clay-ink)]"
        >
          Phases {phasesOpen ? '▾' : '▸'}
        </button>
      </div>
