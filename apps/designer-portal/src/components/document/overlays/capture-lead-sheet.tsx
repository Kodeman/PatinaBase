...
function Input({
  ...
  return (
    <input
      ...
      className="min-h-11 w-full border-b border-[var(--color-pearl)] bg-transparent px-1 py-2 text-[16px] text-[var(--color-charcoal)] placeholder:text-[var(--text-faint)] focus:border-[var(--color-clay)] focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-clay)]"
    />
  );
}
