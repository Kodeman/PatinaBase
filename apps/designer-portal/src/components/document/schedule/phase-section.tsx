    ...
    >
      ...
      <div className={BODY_PAD[state]}>
        {(() => {
          ...
          const foldCls =
            'ml-4 font-mono text-[11px] font-normal uppercase tracking-[0.08em] text-[var(--color-clay-ink)]';
        ...
        {metaLine && (
          <div className="mb-[0.2rem] mt-[0.15rem] font-mono text-[11px] uppercase tracking-[0.08em] text-[var(--color-clay-ink)]">
            {metaLine}
          </div>
        )}
        ...
        {overrunText && (
          <div className="mb-[0.2rem] font-mono text-[11px] uppercase tracking-[0.08em] text-[var(--color-terracotta-ink)]">
            {overrunText}
          </div>
        )}
        ...
        {ghostLine && (
          <div className="mb-[0.2rem] font-mono text-[11px] uppercase tracking-[0.08em]">
