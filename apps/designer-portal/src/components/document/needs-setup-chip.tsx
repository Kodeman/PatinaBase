  ...
  return (
    <div className="mt-1.5">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className="inline-flex items-baseline gap-1 border border-dashed border-[var(--color-aged-oak)] px-2 py-1 font-mono text-[11px] uppercase tracking-[0.14em] text-[var(--color-aged-oak)] hover:text-[var(--color-clay-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-clay)]"
      >
          ...
          ? entries.map((entry) => (
              <li key={entry.text} className="flex flex-wrap items-baseline gap-x-2">
                ...
                <button
                  ...
                  className="font-mono text-[11px] uppercase tracking-[0.06em] text-[var(--color-clay-ink)] underline-offset-2 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-clay)]"
                >
                  {entry.remedyLabel}
                </button>
              </li>
