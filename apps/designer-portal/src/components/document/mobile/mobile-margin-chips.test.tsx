...
describe('MobileMarginChips (D-B30)', () => {
  ...
  it('the letterhead branch lists exactly what useLetterheadMargin yields, tagged data-mobile-margin-chips="letterhead"', () => {
    mockItems = [
      ...
      row({ item_id: 'b', anchor_kind: 'line', anchor_id: 'line-1', title: 'A pieces line item' }),
    ...
    const block = document.querySelector('[data-mobile-margin-chips="letterhead"]');
  ...
  it('the line branch is unaffected — it still filters by anchor_id, ignoring letterhead/section items', () => {
    mockItems = [
      ...
      row({ item_id: 'b', anchor_kind: 'line', anchor_id: 'line-2', title: 'A different line item' }),
      row({ item_id: 'c', anchor_kind: 'letterhead', title: 'A letterhead item' }),
    ];
