...
import { useAdminCatalogPresenter } from '@/features/admin-catalog';
import {
...
const ProductCreateDialog = dynamic(
  () => import('@/components/admin/catalog/product-create-dialog').then(mod => ({ default: mod.ProductCreateDialog })),
  {
    ssr: false,
    loading: () => null,
  }
...
const BulkActionDialogs = dynamic(
  () => import('@/components/admin/catalog/bulk-action-dialogs').then(mod => ({ default: mod.BulkActionDialogs })),
  {
    ssr: false,
    loading: () => null,
  }
