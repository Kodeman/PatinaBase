...
import { Button, Card, CardContent, CardHeader, Tabs, TabsContent, TabsList, TabsTrigger } from '@patina/design-system';
import { toast } from '@patina/design-system';
import { catalogService } from '@/services/admin';
import { DetailsTab, MediaTab, PricingTab, InventoryTab, SEOTab } from '@/components/admin/products/tabs';
