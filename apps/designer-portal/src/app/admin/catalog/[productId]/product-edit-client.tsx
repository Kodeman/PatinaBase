...
// UI components
import { Button, Input, Label, Tabs, TabsList, TabsTrigger, TabsContent, Skeleton, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from '@patina/design-system';
import { toast } from '@patina/design-system';
import { VariantEditor } from '@/components/admin/catalog';
...
export function ProductEditPageClient({ productId }: ProductEditPageClientProps) {
  ...
  // Fetch product data - using the admin hook
  const { product, isLoading, error, refetch, updateProduct, deleteProduct, publishProduct, unpublishProduct } = useAdminProducts({ productId });
  ...
  }, [detailsForm, seoForm, updateProduct]);
  ...
  }, [product, publishProduct, unpublishProduct, refetch]);
