...
import {
  FEATURED_SURFACE_KEYS,
  HELP_TOPICS,
} from "@/lib/help-system/help-topics";
  ...
  return (
    <div className="space-y-10">
      <p className="text-[13px] leading-relaxed text-[var(--text-muted)]">
        Search the articles, browse by topic, or start with one of the featured
        guides.
      </p>
      ...
      <section aria-labelledby="featured-heading" className="space-y-3">
        ...
        {featuredEmpty ? (
          <p className="text-[13px] italic text-[var(--text-muted)]">
            Featured guides arrive as they&apos;re written — browse by topic
            below.
          </p>
        ) : (
          <RelatedArticles
