...
import { Card, Badge, Button } from '@patina/design-system';
import { User, Mail, Shield, Calendar, Monitor, Settings } from 'lucide-react';
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">
                        {sess.deviceInfo?.browser || 'Unknown Device'}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Last active: {formatDate(new Date(sess.lastUsedAt))}
                      </p>
                    </div>
                  </div>
                  {!sess.revokedAt && (
