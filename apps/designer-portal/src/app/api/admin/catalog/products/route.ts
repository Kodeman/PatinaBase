...
// GET /api/admin/catalog/products - List products (admin)
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('[API] GET /admin/catalog/products error:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}

// POST /api/admin/catalog/products - Create product (admin)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[API] POST /admin/catalog/products error:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
