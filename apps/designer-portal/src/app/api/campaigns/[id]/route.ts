...
// GET /api/campaigns/[id] — a single campaign owned by this designer.
export async function GET(
  ...
  if (error || !data) return notFound('Campaign not found');
...
export async function PATCH(
  ...
  // Ownership check: the row must belong to this designer.
