...
let CreateTaskDto = (() => {
    ...
    return class CreateTaskDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _title_decorators = [(0, swagger_1.ApiProperty)({ description: 'Task title' }), (0, class_validator_1.IsString)()];
            ...
            _priority_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Priority', enum: TaskPriority, default: 'medium' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(TaskPriority)];
            _order_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Task order/sequence', default: 0 }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)()];
