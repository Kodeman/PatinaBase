...
exports.UpdateMilestoneDto = exports.MilestoneStatus = void 0;
...
let UpdateMilestoneDto = (() => {
    ...
    return class UpdateMilestoneDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _title_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Milestone title' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            ...
            _targetDate_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Target completion date' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsDateString)()];
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Milestone status', enum: MilestoneStatus }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(MilestoneStatus)];
            _order_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Display order' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)()];
        ...
        status = (__runInitializers(this, _targetDate_extraInitializers), __runInitializers(this, _status_initializers, void 0));
