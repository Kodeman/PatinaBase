...
let UpdateIssueDto = (() => {
    ...
    return class UpdateIssueDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _title_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Issue title' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _description_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Issue description' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            ...
            _severity_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Issue severity', enum: create_issue_dto_1.IssueSeverity }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(create_issue_dto_1.IssueSeverity)];
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Issue status', enum: create_issue_dto_1.IssueStatus }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(create_issue_dto_1.IssueStatus)];
            _resolution_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Resolution description' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
        ...
        status = (__runInitializers(this, _severity_extraInitializers), __runInitializers(this, _status_initializers, void 0));
        resolution = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _resolution_initializers, void 0));
        metadata = (__runInitializers(this, _resolution_extraInitializers), __runInitializers(this, _metadata_initializers, void 0));
        constructor() {
