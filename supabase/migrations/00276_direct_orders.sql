-- ═══════════════════════════════════════════════════════════════════════════
-- 00276 — direct_orders (third payable type on the consolidated payment rail)
--
...
-- `po_payment` (00275). This migration adds the data model for the third and
...
--      invoice_payments (00178) and po_payments (00275), with the same partial-
...
COMMENT ON TABLE public.direct_orders IS
  ...
  'on the consolidated Stripe rail (invoice 00178, po_payment 00275). Rows are '
...
-- naming/style as uniq_po_payments_stripe_* (00275) and the invoice indexes.
