-- ═══════════════════════════════════════════════════════════════════════════
-- 00265 — Auto-draft the deposit invoice at proposal signature
--
...
BEGIN
  ...
  -- 00265: the kickoff milestone (sort_order = 0, seeded 'outstanding' at
  ...
  -- 00265: auto-draft the deposit invoice. Draft only (review-then-send per
...
COMMENT ON FUNCTION public.activate_proposal_as_project(uuid, date) IS
  'Bridges an accepted proposal into an active project (body lineage: 00140 → 00167 → 00180 → 00199 → 00265). '
  '00265 delta: the kickoff (sort_order=0) payment milestone is stamped trigger_kind=''on_signing'' and, when its '
