...
-- rows and may update every pre-00433 field, but cannot forge these snapshots.
...
-- Replace broad pre-00433 table grants with equivalent column grants that omit
...
-- authenticated session; service_role receives only the pre-00433 columns.
