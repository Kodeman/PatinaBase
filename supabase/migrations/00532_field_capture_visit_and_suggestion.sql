-- ═══════════════════════════════════════════════════════════════════════════
-- Migration 00532: field_captures — the visit and the suggestion
--
-- Field Companion wave 3 (package 3-10). Spec §9.3.
--
-- Number drawn from the reserved band 00530–00535 at landing: the file head was
-- 00531, and `git log --all -- 'supabase/migrations/0053*'` showed 00532 free on
-- every ref. Recorded in docs/engineering/migration-number-reservations.md.
-- Applied state was NOT verified from this branch — re-confirm the band against
-- `supabase migration list` on Strata immediately before the push (discipline
