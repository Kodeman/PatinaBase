-- ═══════════════════════════════════════════════════════════════════════════
-- proposal-mood-boards bucket read policy (00131 → 00406 → 00438 → 00487)
--
...
--
-- The DENY cases below are the discriminators. The pre-00487 policy passes
...
-- invisible to the client: that is the status gate 00487 copied from
