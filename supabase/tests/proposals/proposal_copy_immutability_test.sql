...
-- Run:
--   scripts/run-supabase-sql-test.sh supabase/tests/proposals/proposal_copy_immutability_test.sql
...
INSERT INTO fingerprint_column_contract VALUES
  ...
  ('proposal_phases', 'phase',
   ...
   ARRAY['created_at','updated_at','canonical_stage_key','workflow_track',
