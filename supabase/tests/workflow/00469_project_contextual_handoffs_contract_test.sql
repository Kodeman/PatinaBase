-- Fixture-backed contextual handoff projection contract (00469).
...
GRANT EXECUTE ON FUNCTION pg_temp.create_handoff_approval(text, integer, uuid) TO authenticated;
