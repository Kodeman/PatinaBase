...
- `00435_authority_evidence_contract_test.sql` checks household authority,
...
- `00436_lifecycle_compatibility_contract_test.sql` checks the guarded
...
psql 'postgresql://postgres:postgres@127.0.0.1:54322/postgres' \
  -v ON_ERROR_STOP=1 \
  -f supabase/tests/workflow/approval_authority/00435_authority_evidence_contract_test.sql
psql 'postgresql://postgres:postgres@127.0.0.1:54322/postgres' \
  -v ON_ERROR_STOP=1 \
...
00435 extends, rather than replaces, the decision aggregate. The expected
...
These are the fixture-backed blocks to execute once 00435 supplies a legitimate
